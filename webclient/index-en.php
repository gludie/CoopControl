        ...
        <div class="jumbotron" style="padding: 50px 50px;">
            ...
            <form role="form" method="GET" action="index.php">
                <div class="form-group text-center">
                    <button type='submit' class='btn refresh btn-block' name="status">Refresh status</button>
                                <?php
                    ...
                    <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <tr>
                                        <td>Türsensoren</td>
                                        <td>
                                            <span class="label label-<?php echo $arr["Trigger top"]=== '1' ? 'success' :  'default'; ?>">Top</span>
                                            <span class="label label-<?php echo $arr["Trigger bottom"]=== '1' ? 'success' :  'default'; ?>">Bottom</span>
                                    </tr>
                                    <tr>
                                        <td>Motorstatus</td>
                                        <td>
                                            <span class="label label-<?php echo $arr["MotorDirection"]=== '0' ? 'success' :  'default'; ?>">Idle</span>
                                            <span class="label label-<?php echo $arr["MotorDirection"]=== '1' ? 'success' :  'default'; ?>">Up</span>
                                            <span class="label label-<?php echo $arr["MotorDirection"]=== '2' ? 'success' :  'default'; ?>">Down</span>
                                    </tr>
                                    </tbody>
                                    </table>
                        </div>
                        ...
                        <form role="form" method="GET" action="index.php">
                            <div class="form-group">
                                <button type='submit' class='btn refresh btn-block' name="snapshot">Photo refresh</button>
                            <p class='text-center'>
                                <small>Last snapshot at:  <?php echo date("F d Y H:i:s.", filectime("snapshot.jpg")); ?></small>
                            </p>
                            </div>
                        </form>
                        <?php
