...
<a id="pipistatus"></a>
        ...
        <form role="form" method="GET" action="index.php">
          <div class="form-group">
              <button type='submit' class='btn refresh btn-block' name="status">Refresh</button>
            </div>
        </form>
                <?php
...
<!-- end #get the status of time -->         
        ...
        <form role="form" method="GET" action="index.php">
          <div class="form-group">
              <button type='submit' class='btn refresh btn-block' name="snapshot">Take a photo!</button>
            </div>
        </form>
                <?php
        ...
        <?php
            echo "<p class='text-center'>Date of last snapshot: " . date("F d Y H:i:s.", filectime("snapshot.jpg")) . "</p>";
        ?>
        </div>
</div> <!-- /container -->
